...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      keep_type: true,
      keep_num: 1,
      keep_date: moment__WEBPACK_IMPORTED_MODULE_2___default()().add(1, "days"),
      form: {
        category_id: "",
        name: "",
        stages: []
  ...
  computed: {
    days: function days() {
      var days = this.keep_num;

      if (this.keep_type) {
        var keep_date = this.keep_date;

        if (!keep_date._isAMomentObject) {
          keep_date = moment__WEBPACK_IMPORTED_MODULE_2___default()(keep_date, "YYYY-MM-DD");
        }

        days = keep_date.diff(moment__WEBPACK_IMPORTED_MODULE_2___default()(), "days") + 1;
      }

      return days;
    },
    switch_status: function switch_status() {
              ...
              _c("el-form-item", [
                _vm.keep_type
                  ...
                  : _c(
                      ...
                      [
                        _c("el-input-number", {
                          attrs: { min: 1, disabled: _vm.switch_status },
                          model: {
                            value: _vm.keep_num,
                            callback: function($$v) {
                              _vm.keep_num = $$v
              ...
              _c(
                ...
                [
                  _c("el-slider", {
                    ...
                    model: {
                      value: _vm.stage.days,
                      callback: function($$v) {
                        _vm.$set(_vm.stage, "days", $$v)
                      },
                      expression: "stage.days"
                    }
                  })
                ],
                1
